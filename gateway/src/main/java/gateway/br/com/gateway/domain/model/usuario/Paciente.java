...
public class Paciente extends Usuario {
    ...
    public Paciente(UUID id, String nome, String email, String senha, LocalDate dataNascimento, boolean ativo, LocalDateTime criadoEm, LocalDateTime atualizadoEm) {
        this.id = id;
